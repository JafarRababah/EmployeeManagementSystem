...
namespace EmployeesManagment.Controllers
{
    public class WorkFlowUserGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create(WorkFlowUserGroup workFlowUserGroup)
        {
            ...
            {
                TempData["Error"] = "Ann error occured while workFlow user group " + ex.Message;
                ModelState.AddModelError("",ex.Message);
                return View(workFlowUserGroup);
            }
            ViewData["DocumentTypeId"] = new SelectList(_context.SystemCodeDetails.Include(x => x.SystemCodeValue).Where(y => y.SystemCodeValue.Code == "DocumentTypes"), "Id", "Description", workFlowUserGroup.DocumentTypeId);
