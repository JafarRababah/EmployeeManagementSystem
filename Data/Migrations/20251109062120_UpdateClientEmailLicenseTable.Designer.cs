...
namespace EmployeesManagment.Data.Migrations
{
    ...
    [Migration("20251109062120_UpdateClientEmailLicenseTable")]
    partial class UpdateClientEmailLicenseTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeesManagment.Models.FixedAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeesManagment.Models.License", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeesManagment.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeesManagment.Models.FixedAsset", b =>
                {
                    b.HasOne("EmployeesManagment.Models.SystemCodeDetail", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeesManagment.Models.Employee", "ResponsibleEmployee")
                        .WithMany()
